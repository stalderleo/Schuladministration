...
<?php
        foreach ( $v->lehrers as $l ): ?>
            ...
            <tr>
                ...
                <td data-label="Strasse"><?php echo $l->getStrasse()?></td>
                <td data-label="PLZ"><?php if(empty($l->getPlz())) echo ""; else echo $l->getPlz()?></td>
                <td data-label="Ort"><?php echo $l->getOrt()?></td>
                <td data-label="Email"><?php echo $l->getEmail()?></td>
                <td data-label="Telefon privat"><?php echo $l->getTpriv()?></td>
                <td data-label="Telefon gesch."><?php echo $l->getTgesch()?></td>
            </tr>
<?php endforeach; ?>
        </tbody>
    </table>
